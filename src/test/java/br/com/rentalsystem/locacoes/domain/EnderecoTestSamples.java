...
public class EnderecoTestSamples {
    ...
    public static Endereco getEnderecoSample1() {
        return new Endereco().id(1L).cep("cep1").logradouro("logradouro1").numero("numero1").complemento("complemento1").bairro("bairro1");
    }

    public static Endereco getEnderecoSample2() {
        return new Endereco().id(2L).cep("cep2").logradouro("logradouro2").numero("numero2").complemento("complemento2").bairro("bairro2");
    }
