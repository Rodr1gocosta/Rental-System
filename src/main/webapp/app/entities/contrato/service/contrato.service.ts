...
type RestOf<T extends IContrato | NewContrato> = Omit<
  T,
...
export class ContratoService {
  ...
  protected convertDateFromClient<T extends IContrato | NewContrato | PartialUpdateContrato>(contrato: T): RestOf<T> {
    return {
      ...contrato,
      periodo: contrato.periodo?.toJSON() ?? null,
      contratoDataInicio: contrato.contratoDataInicio?.toJSON() ?? null,
      contratoDataFinal: contrato.contratoDataFinal?.toJSON() ?? null,
      contratoDataRetirada: contrato.contratoDataRetirada?.toJSON() ?? null,
      contratoDataEntrega: contrato.contratoDataEntrega?.toJSON() ?? null,
    };
  }
  ...
  protected convertDateFromServer(restContrato: RestContrato): IContrato {
    return {
      ...restContrato,
      periodo: restContrato.periodo ? dayjs(restContrato.periodo) : undefined,
      contratoDataInicio: restContrato.contratoDataInicio ? dayjs(restContrato.contratoDataInicio) : undefined,
      contratoDataFinal: restContrato.contratoDataFinal ? dayjs(restContrato.contratoDataFinal) : undefined,
      contratoDataRetirada: restContrato.contratoDataRetirada ? dayjs(restContrato.contratoDataRetirada) : undefined,
      contratoDataEntrega: restContrato.contratoDataEntrega ? dayjs(restContrato.contratoDataEntrega) : undefined,
    };
  }
