...
const requireRestSample: RestCliente = {
  ...
  estadoEmissaoHabilitacao: sampleWithRequiredData.estadoEmissaoHabilitacao?.format(DATE_FORMAT),
  validadeHabilitacao: sampleWithRequiredData.validadeHabilitacao?.format(DATE_FORMAT),
};
