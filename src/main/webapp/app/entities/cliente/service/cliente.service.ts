...
type RestOf<T extends ICliente | NewCliente> = Omit<T, 'estadoEmissaoHabilitacao' | 'validadeHabilitacao'> & {
  estadoEmissaoHabilitacao?: string | null;
...
export class ClienteService {
  ...
  protected convertDateFromClient<T extends ICliente | NewCliente | PartialUpdateCliente>(cliente: T): RestOf<T> {
    return {
      ...cliente,
      estadoEmissaoHabilitacao: cliente.estadoEmissaoHabilitacao?.format(DATE_FORMAT) ?? null,
      validadeHabilitacao: cliente.validadeHabilitacao?.format(DATE_FORMAT) ?? null,
    };
  }
  ...
  protected convertDateFromServer(restCliente: RestCliente): ICliente {
    return {
      ...restCliente,
      estadoEmissaoHabilitacao: restCliente.estadoEmissaoHabilitacao ? dayjs(restCliente.estadoEmissaoHabilitacao) : undefined,
      validadeHabilitacao: restCliente.validadeHabilitacao ? dayjs(restCliente.validadeHabilitacao) : undefined,
    };
  }
