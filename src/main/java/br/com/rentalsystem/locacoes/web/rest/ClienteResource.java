...
/**
 * REST controller for managing {@link br.com.rentalsystem.locacoes.domain.Cliente}.
 */
@RestController
...
public class ClienteResource {
    ...
    public ResponseEntity<List<ClienteDTO>> getAllClientes(
        ...
        if ("contrato-is-null".equals(filter)) {
            log.debug("REST request to get all Clientes where contrato is null");
            return new ResponseEntity<>(clienteService.findAllWhereContratoIsNull(), HttpStatus.OK);
        }
